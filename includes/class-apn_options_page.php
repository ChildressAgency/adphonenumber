...
if(!class_exists('APN_Options_Page')){
  ...
  class APN_Options_Page{
    ...
    public function add_plugin_page(){
      add_menu_page(
        __('Ad Phone Number', 'ad_phone_number'),
        __('Ad Phone Number', 'ad_phone_number'),
        'manage_options',
        'apn-settings',
    ...
    public function create_admin_page(){
      ...
      <div class="wrap">
        <h1><?php _e('Advertising Phone Number and Usage', 'ad_phone_number'); ?></h1>
    ...
    public function page_init(){
      ...
      add_settings_field(
        'default_phone_number',
        __('Default Phone Number', 'ad_phone_number'),
    ...
    public function print_section_info(){
      printf(__('Enter the default Phone Number', 'ad_phone_number'));
    }
